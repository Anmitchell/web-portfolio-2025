          ...
          <div className='right-section'>
            <div className='content'>
              <section id='about'>
                ...
                <p>
                  ...
                  creating efficient and user-friendly applications. My journey
                  in technology began with a deep curiosity about how things
                ...
                <p>
                  ...
                  projects, learning new technologies, and participating in
                  hackathons. I'm also passionate about teaching and mentoring
                  aspiring developers.
                </p>
              </section>
              ...
              <section id='experience'>
                ...
                <div className='experience-item'>
                  ...
                  <ul>
                    <li>
                      Lead development team in implementing new features and
              ...
              <section id='projects'>
                ...
                <div className='project'>
                  <div className='project-image'>
                    <img
                      src='https://placehold.co/600x400/2e7d32/ffffff?text=E-Commerce'
                ...
                <div className='project'>
                  <div className='project-image'>
                    <img
                      src='https://placehold.co/600x400/1b5e20/ffffff?text=Task+App'
                  ...
                  <div className='project-content'>
                    ...
                    <p>
                      A collaborative task management application built with
                      React and Firebase. Allows teams to organize, track, and
                ...
                <div className='project'>
                  <div className='project-image'>
                    <img
                      src='https://placehold.co/600x400/2e7d32/ffffff?text=Weather'
                  ...
                  <div className='project-content'>
                    ...
                    <p>
                      A weather application that provides detailed forecasts and
                      historical weather data. Built with React and integrated
                      with multiple weather APIs.
                    </p>
                    <ul>
                ...
                {showAllProjects && (
                  <>
                    <div className='project'>
                      <div className='project-image'>
                        <img
                          src='https://placehold.co/600x400/1b5e20/ffffff?text=Analytics'
                      ...
                      <div className='project-content'>
                        ...
                        <p>
                          A data visualization platform for social media metrics
                          and trends.
                        </p>
                        <ul>
                    ...
                    <div className='project'>
                      <div className='project-image'>
                        <img
                          src='https://placehold.co/600x400/2e7d32/ffffff?text=Fitness'
                          alt='Fitness Tracker'
                        />
                      </div>
                      <div className='project-content'>
                        ...
                        <p>
                          A mobile-first fitness tracking application with
                          workout planning and progress monitoring.
                        </p>
                        <ul>
            ...
            <footer className='footer'>
              ...
              <p className='copyright'>
                © {new Date().getFullYear()} Avary Mitchell. All rights
                reserved.
              </p>
            </footer>
          </div>
